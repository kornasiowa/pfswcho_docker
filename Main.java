...
public class Main {
    ...
    private static final String URL = "jdbc:mysql://Full-2020-94877:3306/pfswcho";
    private static final String USER = "dkornas";
    private static final String PASS = "dominika";
